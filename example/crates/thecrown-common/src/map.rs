use minestom::{Player, SharedInstance, instance::InstanceContainer};
...
/// ```
pub fn create_lobby_instance_container(
    instance_manager: &minestom::instance::InstanceManager,
) -> minestom::Result<InstanceContainer> {
    let anvil_path =
